Untar the reference design
--------------------------

1. save the qspi_programmer.tar.gz file in a folder
2. open a nios2 command shell v18.1
3. cd to the project folder
4. untar the archive
	tar xvzf qspi_programmer.tar.gz
	cd to qspi_programmer folder
